...
function DashboardAvatarDropdown() {
  ...
  return (
    <div className="relative flex items-center" onClick={HandleMenuVisable}>
      {/* Avatar */}
      ...
      {isMenuVisible && (
        <div className="absolute top-11 right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-10">
          <div className="p-2">
            {/* Profile Option */}
            <Link to={'/profile'} className="w-full flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-lg">
