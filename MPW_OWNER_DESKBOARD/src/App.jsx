  ...
  return (
    <BrowserRouter>
      <div className={`min-h-screen flex relative `}>
        <aside
          ref={asideRef}
          className={`fixed left-0  top-0 z-[999] min-w-[250px]  bg-white h-screen overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-300 scrollbar-none scrollbar-track-gray-100 border-e lg:transform-none duration-200 ${
